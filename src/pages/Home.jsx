    ...
    <div className="relative min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200">
      ...
      <Section variant="content" className="relative overflow-hidden" id="services">
        ...
        <Container>
          ...
          <div className="text-center max-w-4xl mx-auto mb-8 sm:mb-12 md:mb-16 relative z-10 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8 justify-items-center relative z-10 px-4 sm:px-0">
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className={`relative bg-gradient-to-br ${gradientBg} bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col h-full justify-between group w-full max-w-md`}>
                  {/* Number Badge */}
                  <div className="absolute top-3 right-3 sm:top-4 sm:right-4 w-8 h-8 sm:w-10 sm:h-10 bg-gray-900 text-white rounded-full flex items-center justify-center font-bold text-xs sm:text-sm">
                    0{index + 1}
                  </div>
                  
                  {/* Icon and Title */}
                  <div className="flex flex-col items-center mb-3 sm:mb-4">
                    <div className={`w-12 h-12 sm:w-14 sm:h-16 ${iconBgColor} rounded-xl flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                      <div className="w-6 h-6 sm:w-7 sm:h-8 text-white">
                  ...
                  <div className="mb-4 sm:mb-6 flex-grow">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4 min-h-[140px] sm:h-48 group-hover:bg-blue-100 transition-colors">
                      <h4 className="text-xs sm:text-sm font-bold text-blue-800 uppercase tracking-wider mb-2 sm:mb-3 text-left flex items-center">
                  ...
                  <div>
                    <Link to={feature.link}>
                      <Button variant="secondary" className="w-full text-sm sm:text-base py-2 sm:py-2.5 group-hover:bg-navy group-hover:text-white transition-colors">
                        Learn More
                        <svg className="inline-block w-3.5 h-3.5 sm:w-4 sm:h-4 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Container>
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="text-center mb-8 sm:mb-10 md:mb-12 px-4">
              <div className="inline-block mb-3 sm:mb-4">
                <span className="px-3 sm:px-4 py-1.5 sm:py-2 bg-navy/10 text-navy font-semibold rounded-full text-xs sm:text-sm uppercase tracking-wider">
                  Who We Are
                </span>
              </div>
              <Heading level={2} className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-navy mb-4 sm:mb-6">
            ...
            {/* Main Content Card */}
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl border border-gray-200 overflow-hidden mx-4 sm:mx-0">
              {/* Top Content */}
              <div className="p-5 sm:p-6 md:p-8 lg:p-12">
                <div className="space-y-4 sm:space-y-5 md:space-y-6 text-base sm:text-lg text-gray-700 leading-relaxed">
                  <div className="flex items-start">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-electric mr-3 sm:mr-4 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <p className="text-lg sm:text-xl text-navy font-semibold">
                  ...
                  <p className="pl-0 sm:pl-8 md:pl-10">
              ...
              {/* CTA Button */}
              <div className="p-5 sm:p-6 md:p-8 bg-gray-50 text-center">
                <Link to="/about">
                  <Button variant="primary" className="text-base sm:text-lg px-6 sm:px-8 py-2.5 sm:py-3 group w-full sm:w-auto">
                    Learn More About Us
        ...
        <Container>
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="text-center mb-8 sm:mb-12 md:mb-16 px-4">
              ...
              <Text className="text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed max-w-4xl mx-auto mt-3 sm:mt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 relative px-4 sm:px-0">
              ...
              {/* Step 1 */}
              <div className="relative bg-gradient-to-br from-orange/5 to-orange/0 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                <div className="absolute -top-3 -left-3 sm:-top-4 sm:-left-4 w-10 h-10 sm:w-12 sm:h-12 bg-orange rounded-full flex items-center justify-center font-bold text-white text-base sm:text-lg md:text-xl shadow-lg border-2 sm:border-4 border-white">
                  1
                </div>
                <div className="flex items-start mb-4 sm:mb-6 mt-2 sm:mt-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-orange rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 group-hover:scale-110 transition-transform shadow-lg">
              ...
              {/* Step 2 */}
              <div className="relative bg-gradient-to-br from-electric/5 to-electric/0 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                <div className="absolute -top-3 -left-3 sm:-top-4 sm:-left-4 w-10 h-10 sm:w-12 sm:h-12 bg-electric rounded-full flex items-center justify-center font-bold text-white text-base sm:text-lg md:text-xl shadow-lg border-2 sm:border-4 border-white">
                  2
                </div>
                <div className="flex items-start mb-4 sm:mb-6 mt-2 sm:mt-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-electric rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 group-hover:scale-110 transition-transform shadow-lg">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Step 3 */}
              <div className="relative bg-gradient-to-br from-coral/5 to-coral/0 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                <div className="absolute -top-3 -left-3 sm:-top-4 sm:-left-4 w-10 h-10 sm:w-12 sm:h-12 bg-coral rounded-full flex items-center justify-center font-bold text-white text-base sm:text-lg md:text-xl shadow-lg border-2 sm:border-4 border-white">
                  3
                </div>
                <div className="flex items-start mb-4 sm:mb-6 mt-2 sm:mt-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-coral rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 group-hover:scale-110 transition-transform shadow-lg">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Step 4 */}
              <div className="relative bg-gradient-to-br from-green-500/5 to-green-500/0 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                <div className="absolute -top-3 -left-3 sm:-top-4 sm:-left-4 w-10 h-10 sm:w-12 sm:h-12 bg-green-500 rounded-full flex items-center justify-center font-bold text-white text-base sm:text-lg md:text-xl shadow-lg border-2 sm:border-4 border-white">
                  4
                </div>
                <div className="flex items-start mb-4 sm:mb-6 mt-2 sm:mt-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-green-500 rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 group-hover:scale-110 transition-transform shadow-lg">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-16 p-4 sm:p-6 md:p-8 bg-white rounded-2xl shadow-lg border border-gray-200">
              <div className="flex items-center justify-between gap-1 sm:gap-2 md:gap-4">
                <div className="flex-1 text-center min-w-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-orange rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3 shadow-lg">
                    <span className="text-white font-bold text-sm sm:text-base md:text-xl">1</span>
                  </div>
                  <Text className="text-xs sm:text-sm font-semibold text-navy">Design</Text>
                </div>
                <div className="flex-shrink-0 flex justify-center items-center px-0.5 sm:px-1 md:px-2">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-8 md:h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </div>
                <div className="flex-1 text-center min-w-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-electric rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3 shadow-lg">
                    <span className="text-white font-bold text-sm sm:text-base md:text-xl">2</span>
                  </div>
                  <Text className="text-xs sm:text-sm font-semibold text-navy">Content</Text>
                </div>
                <div className="flex-shrink-0 flex justify-center items-center px-0.5 sm:px-1 md:px-2">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-8 md:h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                ...
                <div className="flex-1 text-center min-w-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-coral rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3 shadow-lg">
                    <span className="text-white font-bold text-sm sm:text-base md:text-xl">3</span>
                  </div>
                  <Text className="text-xs sm:text-sm font-semibold text-navy">Testing</Text>
                </div>
                <div className="flex-shrink-0 flex justify-center items-center px-0.5 sm:px-1 md:px-2">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-8 md:h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                ...
                <div className="flex-1 text-center min-w-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3 shadow-lg">
                    <span className="text-white font-bold text-sm sm:text-base md:text-xl">4</span>
                  </div>
                  <Text className="text-xs sm:text-sm font-semibold text-navy">Growth</Text>
                </div>
              </div>
            </div>
          </div>
        ...
        <Container>
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8 px-4 sm:px-0">
              {/* Feature 1 */}
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-electric/5 rounded-full blur-xl"></div>
                <div className="flex items-start mb-4 sm:mb-6 relative z-10">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-electric rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 group-hover:scale-110 transition-transform shadow-lg">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <Text className="text-sm sm:text-base text-gray-700 leading-relaxed relative z-10">
              ...
              {/* Feature 2 */}
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-orange/5 rounded-full blur-xl"></div>
                <div className="flex items-start mb-4 sm:mb-6 relative z-10">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-orange rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 group-hover:scale-110 transition-transform shadow-lg">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Feature 3 */}
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-coral/5 rounded-full blur-xl"></div>
                <div className="flex items-start mb-4 sm:mb-6 relative z-10">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-coral rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 group-hover:scale-110 transition-transform shadow-lg">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01" />
              ...
              {/* Feature 4 */}
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-green-500/5 rounded-full blur-xl"></div>
                <div className="flex items-start mb-4 sm:mb-6 relative z-10">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-green-500 rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 group-hover:scale-110 transition-transform shadow-lg">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Feature 5 */}
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-purple-500/5 rounded-full blur-xl"></div>
                <div className="flex items-start mb-4 sm:mb-6 relative z-10">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-purple-500 rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 group-hover:scale-110 transition-transform shadow-lg">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Feature 6 */}
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-blue-500/5 rounded-full blur-xl"></div>
                <div className="flex items-start mb-4 sm:mb-6 relative z-10">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-blue-500 rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0 group-hover:scale-110 transition-transform shadow-lg">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Stats Section */}
            <div className="mt-10 sm:mt-12 md:mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 px-4 sm:px-0">
              <div className="text-center">
                <div className="w-12 h-12 sm:w-14 sm:h-16 bg-electric/10 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <svg className="w-6 h-6 sm:w-7 sm:h-8 text-electric" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                </div>
                <div className="text-2xl sm:text-3xl font-bold text-navy mb-1 sm:mb-2">100%</div>
                <div className="text-xs sm:text-sm text-gray-600">B2B Focus</div>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 sm:w-14 sm:h-16 bg-orange/10 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <svg className="w-6 h-6 sm:w-7 sm:h-8 text-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <div className="text-2xl sm:text-3xl font-bold text-navy mb-1 sm:mb-2">24/7</div>
                <div className="text-xs sm:text-sm text-gray-600">Support</div>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 sm:w-14 sm:h-16 bg-coral/10 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <svg className="w-6 h-6 sm:w-7 sm:h-8 text-coral" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div className="text-2xl sm:text-3xl font-bold text-navy mb-1 sm:mb-2">99.9%</div>
                <div className="text-xs sm:text-sm text-gray-600">Uptime</div>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 sm:w-14 sm:h-16 bg-green-500/10 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <svg className="w-6 h-6 sm:w-7 sm:h-8 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                  </svg>
                </div>
                <div className="text-2xl sm:text-3xl font-bold text-navy mb-1 sm:mb-2">100%</div>
      ...
      <Section variant="content" className="bg-blue-50 relative overflow-hidden">
        ...
        <Container>
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 md:gap-8 mb-10 sm:mb-12 md:mb-16 px-4 sm:px-0">
              {/* Industry 1 */}
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-orange/5 rounded-full blur-xl"></div>
                <div className="flex items-start mb-4 sm:mb-6 relative z-10">
                ...
                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200 relative z-10">
                  <div className="flex flex-wrap gap-2">
                    <span className="px-2.5 sm:px-3 py-1 bg-orange/10 text-orange text-xs font-medium rounded-full">Window Tinting</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-orange/10 text-orange text-xs font-medium rounded-full">Auto Detailing</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-orange/10 text-orange text-xs font-medium rounded-full">HVAC</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-orange/10 text-orange text-xs font-medium rounded-full">Cleaning</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200 relative z-10">
                  <div className="flex flex-wrap gap-2">
                    <span className="px-2.5 sm:px-3 py-1 bg-electric/10 text-electric text-xs font-medium rounded-full">Factories</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-electric/10 text-electric text-xs font-medium rounded-full">Fabrication</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-electric/10 text-electric text-xs font-medium rounded-full">Logistics</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-electric/10 text-electric text-xs font-medium rounded-full">Supply Chain</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200 relative z-10">
                  <div className="flex flex-wrap gap-2">
                    <span className="px-2.5 sm:px-3 py-1 bg-coral/10 text-coral text-xs font-medium rounded-full">Developers</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-coral/10 text-coral text-xs font-medium rounded-full">Renovation</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-coral/10 text-coral text-xs font-medium rounded-full">Maintenance</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-coral/10 text-coral text-xs font-medium rounded-full">Portfolio</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-5 sm:p-6 md:p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200 relative z-10">
                  <div className="flex flex-wrap gap-2">
                    <span className="px-2.5 sm:px-3 py-1 bg-green-500/10 text-green-500 text-xs font-medium rounded-full">Agencies</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-green-500/10 text-green-500 text-xs font-medium rounded-full">Consultants</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-green-500/10 text-green-500 text-xs font-medium rounded-full">Creative Studios</span>
                    <span className="px-2.5 sm:px-3 py-1 bg-green-500/10 text-green-500 text-xs font-medium rounded-full">Digital</span>
                  </div>
                </div>
              </div>
            </div>
