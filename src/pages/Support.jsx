...
const Support = () => {
  ...
  return (
    <>
      ...
      <Section variant="content" className="bg-blue-50 py-6">
        <Container>
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center">
                <svg className="w-6 h-6 text-electric mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <div>
                  <Text className="text-navy font-semibold">Support Hours</Text>
                  <Text className="text-gray-600 text-sm">Monday - Friday, 9:00 AM - 6:00 PM CST</Text>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <a href="mailto:support@stratigo.io">
        ...
        <Container>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <Heading level={2} className="text-4xl font-bold text-navy mb-4">
              ...
              {supportCategories.map((category, index) => (
                <div key={index} className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 hover:shadow-xl transition-all duration-300">
                  <div className="flex items-start mb-6">
                    <div className={`w-14 h-14 ${category.iconColor} rounded-xl flex items-center justify-center mr-4 flex-shrink-0`}>
                      {category.icon}
                    </div>
                    <div>
                      <Heading level={3} className="text-2xl font-bold text-navy mb-2">
                        {category.title}
                      </Heading>
                  ...
                  <div className="space-y-2">
                    {category.links.map((link, idx) => (
                      <a
                        key={idx}
                        href={link.url}
                        className="flex items-center text-electric hover:underline transition-colors group"
                      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {quickLinks.map((item, index) => (
                <a
                  key={index}
                  href={item.link}
                  className="bg-white rounded-xl shadow border border-gray-200 p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                >
                  <div className="text-4xl mb-4">{item.icon}</div>
                  <Heading level={4} className="text-lg font-bold text-navy mb-2">
                    {item.title}
                  </Heading>
              ...
              {commonIssues.map((item, index) => (
                <details key={index} className="bg-white rounded-lg shadow border border-gray-200 overflow-hidden group">
                  <summary className="px-6 py-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-center justify-between">
                    <Text className="font-semibold text-navy flex items-center">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
                ...
                <Heading level={3} className="text-xl font-bold text-white mb-2">
                  Email Support
                </Heading>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
                ...
                <Link to="/contact" className="text-electric hover:underline font-medium">
                  Open Support Ticket
                </Link>
              </div>
            ...
            <div className="mt-12 p-6 bg-white/5 rounded-lg border border-white/10">
              <div className="flex items-start">
                <svg className="w-6 h-6 text-blue-300 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                </svg>
                <div>
                  <Text className="text-white font-semibold mb-1">Before Contacting Support</Text>
