...
const Hosting = () => {
  ...
  return (
    <>
        ...
        <div className="hero-content">
          <div className="hero-content-inner">
            <Heading level={1} variant="hero" className="text-white text-center text-6xl md:text-7xl mb-8">
              Stratigo fully Managed Hosting, Built Exclusively For Our Clients
            </Heading>
            
            <Text variant="hero" className="text-white text-center max-w-none mx-auto text-xl leading-relaxed">
              With Stratigo, your digital success is our mission. We don't just provide space--we design, host, and accelerate your entire online presence. Hosting comes standard with our expert software developement and marketing solutions.
            </Text>
      ...
      {/* Pricing Section */}
      <Section variant="content" id="pricing-plans">
        <Container>
          <div className="text-center mb-16">
            <Heading level={2} className="text-4xl md:text-5xl font-bold text-navy mb-6">
              Stratigo Hosting Plans
            </Heading>
            <Text className="text-xl text-gray-600 max-w-3xl mx-auto mb-4">
              Exclusively for Stratigo Development Clients
            </Text>
            <Text className="text-lg text-gray-500 max-w-3xl mx-auto mb-8">
          ...
          <div className="mt-20 text-center">
            <Heading level={3} className="text-3xl md:text-4xl font-bold text-navy mb-12">
          ...
          <div className="mt-20">
            <div className="text-center mb-16">
              ...
              <Text className="text-lg text-gray-600 max-w-4xl mx-auto mb-4">
              ...
              <Text className="text-md text-gray-500 max-w-3xl mx-auto">
          ...
          <div className="mt-20">
            <div className="text-center mb-16">
              ...
              <Text className="text-xl text-gray-600 max-w-4xl mx-auto mb-4">
              ...
              <Text className="text-lg text-gray-500 max-w-4xl mx-auto">
                We don't just provide server space — we deliver a fully managed environment designed to scale with your website and your business.
              </Text>
            </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700">Private hosting environment — no shared resources</span>
                    </div>
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-electric mr-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          <div className="mt-20">
                    ...
                    <tr>
                      ...
                      <th className="px-6 py-4 text-center text-sm font-semibold text-gray-900">
                        <div className="flex items-center justify-center space-x-2">
                          ...
                          <span>Stratigo Managed Hosting</span>
                        </div>
                      </th>
                    </tr>
                  </thead>
            ...
            <div className="mt-12 text-center">
              <div className="bg-gradient-to-r from-electric/10 to-blue-100 rounded-2xl p-8 max-w-4xl mx-auto">
                <div className="flex items-center justify-center gap-3 mb-4">
                  <svg className="w-8 h-8 text-electric" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-20">
            <div className="text-center mb-16">
              <Heading level={3} className="text-3xl md:text-4xl font-bold text-navy mb-6">
                Frequently Asked Questions – Stratigo Hosting
              </Heading>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow duration-200">
                    <button
                      className="w-full p-6 text-left flex items-center justify-between bg-white hover:bg-gray-50 transition-colors duration-200 border-0"
                      onClick={() => toggleFAQ(index)}
                    >
                      <div className="flex items-center space-x-4 flex-1">
                        <div className="w-10 h-10 bg-electric/10 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm">
                          <svg className="w-5 h-5 text-electric" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex-shrink-0">
                        <svg 
                          className={`w-6 h-6 text-electric transition-transform duration-200 ${openFAQ === index ? 'rotate-180' : ''}`} 
                          fill="none" 
                          stroke="currentColor" 
                          viewBox="0 0 24 24"
                        >
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center text-white">
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white">
              Ready to Host Your Website the Right Way?
            </h2>
          </div>
          ...
          <div className="mb-10">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white">
                Reliable. Scalable. Backed by Experts.
              </h3>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-10">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h4 className="text-2xl font-bold text-white">What You Get:</h4>
            </div>
            <div className="grid md:grid-cols-2 gap-4 text-left max-w-3xl mx-auto">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-white font-medium">Fully Managed Hosting (on world-class cloud servers)</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-6 h-6 text-green-300 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span className="text-white font-medium">CMS Dashboard Access to manage your content easily</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-6 h-6 text-green-300 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span className="text-white font-medium">Priority Support — directly from the team that built your site</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-6 h-6 text-green-300 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span className="text-white font-medium">Fast, secure, and scalable setup tailored for your business</span>
              </div>
            </div>
          </div>

          {/* Exclusive Note */}
          <div className="bg-navy/30 backdrop-blur-sm rounded-xl p-6 mb-10 border border-white/20">
            <div className="flex items-center justify-center gap-3 mb-2">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <p className="text-lg text-white font-semibold">Hosting is exclusive to Stratigo clients</p>
            </div>
            <p className="text-white/90">
              We only host websites for businesses using our software development or marketing services. That way, you get dedicated infrastructure, fewer risks, and hands-on expertise at every step.
            </p>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center gap-3">
              ...
              <h4 className="text-2xl font-bold text-white">Choose Your Plan and Get Online Fast</h4>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={scrollToPricing}
              className="bg-white hover:bg-gray-100 text-electric font-semibold py-4 px-8 rounded-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-200"
            >
              View Hosting Plans
            </button>
            <button className="bg-white hover:bg-gray-100 text-electric font-semibold py-4 px-8 rounded-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-200">
