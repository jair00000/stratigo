      ...
      <Section variant="content" className="relative overflow-hidden">
        ...
        <Container>
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <Text className="text-lg text-gray-600 leading-relaxed mb-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-electric/5 border border-blue-200 rounded-2xl p-8 mt-6">
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center relative z-10">
            {coreServices.map((service, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col h-full relative group">
                  {/* Individual blur element */}
                  <div className={`absolute -top-20 -left-20 w-40 h-40 ${blurColor} rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
                  
                  {/* Number Badge */}
                  <div className={`absolute -top-3 -right-3 w-10 h-10 ${gradientBg} rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg`}>
                    {index + 1}
                  </div>

                  {/* Icon and Title */}
                  <div className="flex flex-col items-center mb-4">
                    <div className={`w-16 h-16 ${gradientBg} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                      {service.icon}
                    </div>
                  ...
                  {/* Includes Section */}
                  <div className="mb-4">
                    <div className="bg-gradient-to-br from-blue-50 to-electric/5 border border-blue-200 rounded-xl p-4">
                      <div className="flex items-center justify-center mb-3">
                        <svg className="w-5 h-5 text-electric mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <h4 className="text-sm font-bold text-electric uppercase tracking-wider">Includes</h4>
                      </div>
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {whyChoose.map((item, index) => {
                ...
                return (
                  <div key={index} className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 relative group">
                    {/* Individual blur element */}
                    <div className={`absolute -top-20 -right-20 w-40 h-40 ${blurColor} rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
                    
                    <div className="flex items-start mb-4">
                      <div className={`w-16 h-16 ${gradientBg} rounded-2xl flex items-center justify-center mr-4 flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}>
                        {item.icon}
                      </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto text-center text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <Text className="text-white font-semibold mb-2">Performance Driven</Text>
                <Text className="text-white/70 text-sm">Built for speed and efficiency</Text>
              </div>
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <Text className="text-white font-semibold mb-2">Secure by Design</Text>
                <Text className="text-white/70 text-sm">Enterprise-grade security</Text>
              </div>
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <Text className="text-white font-semibold mb-2">Scalable Solutions</Text>
                <Text className="text-white/70 text-sm">Grows with your business</Text>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-white/80">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm">Development Inquiries</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center">
                ...
                <div>
                  <div className="font-semibold text-white">Free Project Scope</div>
                  <div className="text-sm">30-minute consultation call</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="text-sm">Project starts within 48 hours</div>
                </div>
              </div>
            </div>
          </div>
